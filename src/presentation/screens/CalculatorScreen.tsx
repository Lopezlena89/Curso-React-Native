  ...
  return (
    <View style={styles.calculatorContainer}>
        ...
        <View style={styles.row}>
            <CalculatorButton onPress={()=> console.log('C')} label='C' blackText color={colors.ligthGray}/>
            <CalculatorButton onPress={()=> console.log('+/-')} label='+/-' blackText color={colors.ligthGray}/>
            <CalculatorButton onPress={()=> console.log('del')} label='del' blackText color={colors.ligthGray}/>
        ...
        <View style={styles.row}>
            ...
            <CalculatorButton onPress={()=> console.log('7')} label='-' color={colors.orange}/>
        </View>
        <View style={styles.row}>
