  ...
  return (
    <View style={styles.calculatorContainer}>
        ...
        <View style={styles.row}>
            <CalculatorButton onPress={clean} label='C' blackText color={colors.ligthGray}/>
            <CalculatorButton onPress={toggleSign} label='+/-' blackText color={colors.ligthGray}/>
            <CalculatorButton onPress={deleteOperation} label='del' blackText color={colors.ligthGray}/>
